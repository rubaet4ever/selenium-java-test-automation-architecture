...
public class RoleTest {
	public static void createRole(WebDriver driver) {
		try {
		Thread.sleep(2000);
	...
	public static void updateRole(WebDriver driver) {
		try {
		Thread.sleep(2000);
		driver.findElement(By.id("email")).sendKeys("rubaet@cnm.com");
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//li[@id='role_23_47']/a")).click();
		Thread.sleep(2000);
		
		//driver.findElement(By.xpath("//ul[@id='myTab']/li[2]/a/span")).click();
		//Thread.sleep(2000);
		
		driver.findElement(By.xpath("//div[@id='role-tab-1']/div/div/div/div/div/div/div[2]/span/button")).click();
		Thread.sleep(2000);
	    
		driver.findElement(By.id("reference")).clear();
	    driver.findElement(By.id("reference")).click();
	    driver.findElement(By.id("reference")).sendKeys("Role06");
	    Thread.sleep(1000);
	    
	    driver.findElement(By.id("roleLocale.name")).clear();
	    driver.findElement(By.id("roleLocale.name")).click();
	    driver.findElement(By.id("roleLocale.name")).sendKeys("Role-6");
	    Thread.sleep(2000);
	    ...
	    driver.findElement(By.cssSelector(".pull-right:nth-child(1) > .btn-sm:nth-child(1)")).click();
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//form[@id='role_employee_form_submit']/div[2]/button")).click();
	    Thread.sleep(2000);
